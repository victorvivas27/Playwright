Feature: Funcionalidad de compra login
 ...
 @login @login-compra @positivo 
  ...
  @login @login-filtro-orden-compra @positivo
...
@login @login-campos-vacios @negativo
...
@login @eliminar-producto-carrito @negativo
